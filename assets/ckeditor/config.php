...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => 'uploads/cms/',
  	'root'         => __DIR__ . '/../../uploads/cms/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
//	'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'allowedExtensions' => 'avi,bmp,csv,doc,docx,gif,jpeg,jpg,mid,mov,mp3,mp4,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,rtf,txt,wav,wma,wmv,xls,xlsx,zip,rar',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
