<div class="container">
    <div class="row justify-content-center mt-lg-5">
        <div class="col-6">
            ...
            <?php endif;?>
            <form method="post" action="<?php echo site_url('users/update/' . $item->id);?>">
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           placeholder="Nome"
                           value="<?php echo set_value('nome', $item->name);?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           placeholder="Login"
                           value="<?php echo set_value('login', $item->login);?>">
                ...
                <div class="form-group">
                    ...
                    <input type="password"
                           ...
                           placeholder="Senha"
                           value="<?php echo set_value('password', $item->password);?>">
