				...
				<div class="slick-default slick-banner">
					...
					<div>
						<a href="<?php echo $banner->link;?>">
							<img src="<?php echo $banner->getImageUrl();?>" alt="<?php echo $banner->title;?>" title="<?php echo $banner->title;?>" />
						</a>
					</div>
					<?php endforeach;?>
				</div>
				...
				<div class="p-2">
					<div class="service-content">
						<a href="<?php echo site_url($service->slug);?>">
							<img class="service-image" src="<?php echo $service->getImageUrl();?>" alt="<?php echo $service->title;?>" title="<?php echo $service->title;?>"/>
						</a>
					</div>
				</div>
			</div>
