<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v5.0&appId=956629498038980&autoLogAppEvents=1"></script>
<main>
	<div class="container">
		<hr>
		<div class="row">
				...
				<?php if (isset($created_at) && !empty($created_at) || isset($author) && !empty($author)): ?>
					<p>
						...
						<?php if (isset($created_at) && !empty($created_at)): ?>
							<time itemprop="datePublished" datetime="<?php echo $created_at; ?>"> em <?php echo date('d/m/Y', strtotime($created_at)); ?> </time>
						<?php endif; ?>
					</p>
				<?php endif; ?>
		...
		<div class="row">
			<div class="col-12">
				<div class="fb-comments" data-href="<?php echo site_url($slug);?>" data-width="100%" data-numposts="20"></div>
			</div>
		</div>
		<hr>
	</div>
