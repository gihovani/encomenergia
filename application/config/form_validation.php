...
$config = [
    ...
    'posts/create' => [
        [
            'field' => 'type',
            'label' => 'Tipo',
            'rules' => 'trim|required|callback_do_upload'
        ],
        [
            'field' => 'title',
            'label' => 'Título',
            'rules' => 'trim|required|max_length[70]|is_unique[posts.title]'
        ],
        [
            'field' => 'description',
            'label' => 'Descrição',
    ...
    'banners/create' => [
        [
            'field' => 'title',
            'label' => 'Título',
            'rules' => 'trim|max_length[70]|required|callback_do_upload'
        ],
        [
            'field' => 'link',
            'label' => 'Link',
    ...
    'contacts/create' => [
        ...
        [
            'field' => 'email',
            'label' => 'E-mail',
            'rules' => 'trim|max_length[200]|valid_email|required'
        ],
        [
            'field' => 'phone',
            'label' => 'Telefone',
